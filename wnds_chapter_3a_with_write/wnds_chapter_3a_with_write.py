...
my_file_object = open('my_file.txt', 'w')  # opens file for writing
...
# go to the working directory and locate the file
# drag the file into your favorite text editor (e.g. notepad++ on Windows)